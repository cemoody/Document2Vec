...
from corpora import SeriesCorpus

w2v_file = os.path.realpath("models/data-all-02.py2.small")
...
class TestDoc2Vec(unittest.TestCase):
    ...
    def test_load_from_w2v(self):
        ...
        self.assertIn('pixley', model.index2word)
    ...
    def test_transform(self):
        ...
        sim = model.word_similarity('SENT_0', word)
